...
在 3D 视图中按键盘 N 键打开侧边栏，找到 PrintPrep (打印分件) 面板即可开始使用！
...
本插件原生支持 简体中文 (Simplified Chinese) 与 English。
界面语言会完全自动跟随你的 Blender 软件语言设置（需在偏好设置中开启 Interface (界面) 翻译选项）。

👨‍💻 关于作者 (About the Authors)

设计与开发 (Developers)：小王子 & 第九题 (Little Prince & 9th)

开源协议 (License)：GPL-2.0-or-later

如果您觉得这个插件对您的 3D 打印之旅有帮助，欢迎在 GitHub 上点个 ⭐ Star！
